...
$reminderdate = $_GET["reminderdate"];
...
$mail2->addAddress('reminder@stayintouchplease.com');
                            ...
                            <table width='95%' border='0' cellpadding='0' cellspacing='0'
                                ...
                                <tr>
                                    <td style='padding:0 35px;'>
										...
										Hello - This is a reminder to reach out to <b>$fullname</b>.<br>
										The occasion is <b>$occasion</b> which occurs on <b>$reminderdate</b><br>
										Thank you.
                                        </p>
                                    </td>
                                </tr>
...
if(!$mail2->Send()) {
    ...
    echo ("<script LANGUAGE='JavaScript'>window.location.href='https://stayintouchplease.com/public/';</script>");
    exit; 
 };

//REDIRECT TO PAGE AFTER SUBMIT
echo ("<script LANGUAGE='JavaScript'>window.location.href='https://stayintouchplease.com/public/index.php/homepage';</script>");
